...
export class SchoolSpring {
    ...
    constructor(page: Page, id?: string) {
        ...
        this.department = page.locator('.jobCategories-value-0');
        this.description = page.locator('.jobDescription-content.ats-job-description-styles')
    ...
    async getJobs(): Promise<Job[]> {
        ...
        for (let i = 0; i < count; i++) {
            ...
            const department = await this.department.nth(1).allInnerTexts();
            const description = await this.description.allInnerTexts();
            const entityId = id;
